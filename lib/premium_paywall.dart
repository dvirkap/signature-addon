      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            // Benefit Checkmarks
            _buildBenefitItem(Icons.pages_outlined, isRtl ? 'עריכת דפי מסמך (סיבוב, מחיקה)' : 'Edit PDF pages (Rotate, delete)'),
            ...
            _buildBenefitItem(Icons.edit, isRtl ? 'ציור וסימון חופשי בעיפרון (בצבעים שונים)' : 'Draw & highlight freely with pencil (custom colors)'),
            _buildBenefitItem(Icons.cleaning_services, isRtl ? 'מחק מרובע ועגול למחיקת טקסט ותוכן' : 'Square & round eraser to remove text or content'),
            _buildBenefitItem(Icons.lock_outline, isRtl ? 'נעילת ציר אופקי למחיקה וסימון ישרים' : 'Horizontal axis lock for straight drawing/erasing'),
            const SizedBox(height: 24),
            const Divider(color: Color(0xFF1E293B)),
            const SizedBox(height: 24),
            // Upgrade button
